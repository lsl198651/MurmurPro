...
if __name__ == '__main__':
    ...
    # TODO 改模型名字
    parser.add_argument(
        "--model", type=str, default="logmel + se_resnet6v2  4k  samplerWeight[1,5] lr=0.001,32,64 channel reductiom=8 high_freq=1000, window_type='hanning'")
    ...
    parser.add_argument("--train_fold", type=list,
                        default=['0', '2', '3', '4'])
    parser.add_argument("--test_fold", type=list, default=['1'])
